...
public class MovingRotorTest {
    ...
    public void testAtNotch() {
        MovingRotor mRotor = new MovingRotor(
                "mRotor1", new Permutation(NAVALA.get("I"), UPPER), "CD");
        mRotor.set(1);
        assertFalse(mRotor.atNotch());
        mRotor.set(2);
        assertTrue(mRotor.atNotch());
        mRotor.set(3);
        assertTrue(mRotor.atNotch());
    }
    ...
    public void testAdvance() {
        MovingRotor mRotor2 = new MovingRotor(
                "mRotor2", new Permutation(NAVALA.get("I"), UPPER), "DE");
        mRotor2.set(0);
        mRotor2.advance();
        assertEquals(1, mRotor2.setting());
        mRotor2.advance();
        assertEquals(2, mRotor2.setting());
        mRotor2.set(25);
        mRotor2.advance();
        assertEquals(0, mRotor2.setting());
    }
